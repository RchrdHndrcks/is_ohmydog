class DogWalkersSittersContactController < ApplicationController
    ...
    def create
      ...
      if @dog_walkers_sitters_contact.save
        ...
        PostAdoptionMailer.contact_email(@dog_walkers_sitters_contact, post_creator_email, admin_emails).deliver_later
    ...
    def dog_walkers_sitters_contact_params
      params.require(:dog_walkers_sitters_contact).permit(:nombre, :correo, :telefono, :mensaje)
    end
  end
