...
class DogWalkerMailer < ApplicationMailer
    def contact_email(dog_walkers_sitters_contact, post_creator_email, cc_emails)
      ...
      mail(to: @post_creator_email, cc: cc_emails, subject: 'Alguien se ha interesado en tu servicio!')
    end
  end
